                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          //     final hints = controller.hints;
                          //     int crossAxisCount =
                          //         (Get.context?.isPhone ?? true) ? 4 : 4;
                          //     double spacing =
                          //         (Get.context?.isPhone ?? true) ? 2 : 4;
                          //     double cellSize =
                          //         screenWidth * 0.2; // Adjust based on design
                          ...
                          //     return Container(
                          //       margin: EdgeInsets.symmetric(
                          //         // vertical: (Get.context?.isPhone ?? true) ? screenWidth * 0.02 : screenWidth * 0.03,
                          //         // horizontal: (Get.context?.isPhone ?? true) ? screenWidth * 0.09 : screenWidth * 0.07,
                          //         vertical: (Get.context?.isPhone ?? true)
                          //             ? screenWidth * 0.02
                          //             : screenWidth * 0.03,
                          ...
                          //       ),
                          //       //  padding: EdgeInsets.all(
                          //       //   (Get.context?.isPhone ?? true) ? screenWidth * 0.01 : screenWidth * 0.02,
                          //       // ),
                          //       child: IntrinsicWidth(
                          //         child: Column(
                          //           children: [
